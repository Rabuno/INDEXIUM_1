...
-- Bổ sung Chỉ mục Đảo (Inverted Index) cho tìm kiếm bài viết
-- Sử dụng parser chuẩn cho dữ liệu tiếng Việt / Unicode
ALTER TABLE posts 
ADD FULLTEXT INDEX idx_fts_search (title, description, content);